...
https://www.tenouk.com/ModuleO1.html
 */
#include <windows.h>
#include <stdio.h>
#include <tchar.h>
...
bool Set_RegistryValue(int argc, char *argv[], HKEY hKeyRoot, LPCTSTR pszSubKey, LPCTSTR pszValue, void* value){
  int argv_read = 4;
